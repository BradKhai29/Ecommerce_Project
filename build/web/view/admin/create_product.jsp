...
<html>
    ...
    <body>
        <header class="navbar navbar-expand navbar-dark sticky-top bg-dark flex-md-nowrap p-0 mb-5 shadow">
            ...
            <div class="bg-dark w-100 text-center text-light fw-bold">CREATE PRODUCT PAGE</div>
            ...
            <div class="row">
                <nav aria-label="breadcrumb" class="bg-dark text-light rounded-3 p-3 px-5 mb-4">
                    <ol class="breadcrumb mb-0 fw-bold text-light">
                        ...
                        <li class="breadcrumb-item active text-light" aria-current="page">Create Product</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <form class="row" action="product" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                                ...
                                <div class="white-box text-center rounded-3">
                                    <label for="productImg" class="form-label">
                                        <picture class="card-img-top rounded-3" width="100%" height="340px">
                                            ...
                                            src="${root}/product/placeholder.png" 
                                            alt="product image">
                                        </picture>
                                    </label>
                                    <input class="form-control" type="file" 
                                    accept=".png, .jpg, .jpeg, .svg, .webp" 
                                    id="productImg" onchange="loadFile(event)" required>
                                </div>
                            </div>
                            <section class="col-lg-7 col-md-7 col-sm-6 mt-0">
                                ...
                                <div class="btn-group d-flex gap-2">
                                    ...
                                    <button type="submit" class="col-8 rounded-3 btn btn-warning border-2 fw-bold" name="command" value="_">Tạo sản phẩm</button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="staticBackdropLabel">Bạn định hủy tạo mới sản phẩm</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    Mọi thông tin của sản phẩm sẽ không được lưu lại, bạn chắc chứ?
                                                </div>
